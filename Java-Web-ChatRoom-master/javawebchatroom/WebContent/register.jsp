...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .five.wide.column {
                background-size: cover;
                background: url(images/red_regi.jpg) 60% 0%;
            }
        ...
        <div class="ui grid divided segment container">
            ...
            <div class="eleven wide column">
                <h4 class="ui inverted right aligned header">
                    <a href="${pageContext.request.contextPath }/login.jsp" style="color:#ff695e;">前往登录</a>
                </h4>
			<h3 align="center" style="color:red;">${error}</h3>
	    		...
	    		<input type="hidden" name="method" value="register">
                         ...
                         <div class="field">
                                	用户名
                                <input autofocus="" id="id_username" maxlength="150" name="username" type="text" required />
                            </div>
                        
                            <div class="field">
                                	密码
                                <input id="id_password1" name="password" type="password" required />
                            </div>
                        
                            <div class="field">
                                	确认密码
                                <input id="id_password2" name="repassword" type="password" required />
                            </div>
                        
                    <button class="ui inverted red circular right floated button" type="submit">注册</button>
                </form>
            </div>
        </div>
    </body>
